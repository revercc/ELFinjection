...
size_t get_new_file_size(
    ...
    uint32_t *p_new_load_program_size,
    u_long *p_new_dynamic_off,
    uint32_t *p_new_dynamic_size,
    u_long *p_new_dynstr_off,
    uint32_t *p_new_dynstr_size,
    u_long *p_new_interp_off,
    uint32_t *p_new_interp_size,
    u_long *p_new_note_off,
    uint32_t *p_new_note_size,
    uint32_t *p_new_program_header_table_size)
{   
    if(
        NULL == fd || 
        NULL == lib_path || 
